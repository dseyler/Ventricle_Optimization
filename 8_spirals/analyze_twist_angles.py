...
def analyze_twist_angles_example(reference_surface=None, pressure_file=None):
    ...
    results_folder = "results_" + reference_surface.split("/")[-3].split("-")[0]  # Update this path
    ...
    output_dir = "twist_analysis_" + reference_surface.split("/")[-3].split("-")[0]
    ...
    if pressure_file is not None:
        ...
        output_dir = output_dir + "_" + pressure_str
